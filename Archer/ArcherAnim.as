...
void onTick(CSprite@ this)
{
	...
	const bool inair = (!has_ground && !blob.isOnLadder());
	...
	if (is_flipped) aimpos.RotateBy(180, blob.getPosition());
...
void doRopeUpdate(CSprite@ this, CBlob@ blob, ArcherInfo@ archer)
{
	...
	rope.RotateBy(-off.Angle() + fr, Vec2f());
	...
	hook.RotateBy(archer.cache_angle + fr, Vec2f());

	hook.TranslateBy(off * ff);
